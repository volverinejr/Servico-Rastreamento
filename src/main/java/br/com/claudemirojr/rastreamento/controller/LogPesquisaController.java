...
public class LogPesquisaController {
	 ...
	 * LogPesquisaDto logPesquisaDto) { logPesquisaService.criar(logPesquisaDto);
	 * 
	 * return new ResponseEntity<Success>(HttpStatus.ACCEPTED); }
	 * 
	 * 
	 * @PostMapping public ResponseEntity<LogPesquisaResponseDto>
	 * create(@RequestBody @Valid LogPesquisaDto logPesquisaDto) {
